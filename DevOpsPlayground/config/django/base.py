...
LOCAL_APPS = [
    'devopsplayground.core.apps.CoreConfig',
    ...
    'devopsplayground.tasks.apps.TasksConfig',
]
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'devopsplayground.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'devopsplayground.api.exception_handlers.hacksoft_proposed_exception_handler',
